...
<body oncontextmenu="return false">
	...
	<div id="nt-container" style="background-color:#3c3a48;">
        ...
        <ul id="nt">
   	   ...
   	   <li>The Website is Designed by Vedant Jain... <a href="#">Read more...</a></li>
...
<div class="foot"> 
	<div class="row"><br><br>
		<div class="four columns offset-by-one" style="border:1px dashed white; border-radius:5px; text-align:center;" >
			<span style="font-size:1.2em;">Designed By :</span>  <a href="https://www.facebook.com/vedant.jain.14224">Vedant Jain</a>
...
<div id="popup_3" class="popup" style="z-index:200; position:fixed;">
  ...
  <div class="popup-content">
    ...
    <div class="content row">
		...
		<form method="POST" action="http://localhost:8080/signIn/company" accept-charset="UTF-8"><input name="_token" type="hidden" value="2iQlr8QR6Emun17rmzWKtNFTZCLCdFJrB0ZIQe6G">
		<input name="entity" type="hidden" value="company">
	    ...
	    <div class="eight columns offset-by-two">
	        ...
	        <a href="/register" class="twelve columns button">Register</a>
	    </div>
